            ...
            <Card className="dark-card gradient-hover">
              <CardContent className="p-8">
                ...
                <p className="text-gray-300 mb-4 leading-relaxed">
                  Four specialized AI agents coordinate in real-time to handle every customer interaction from first contact to confirmed booking. Each agent excels in their role while seamlessly handing off context to teammates. Sub-600ms response times deliver enterprise-grade coordination with human-quality conversations.
                </p>
                <div className="p-4 rounded-lg bg-[#00839C]/10 border border-[#00839C]/20 mb-6">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Convert 40% more leads with 24/7 instant response. Reduce labor costs by 60-75% while improving quality. Eliminate scheduling friction, reduce no-shows by 35%, and scale engagement without scaling headcount.
                  </p>
                </div>
                <Button
                  onClick={() => setIsAgentModalOpen(true)}
